...
var VueTester = /** @class */ (function (_super) {
    ...
    function VueTester(wrapper) {
        ...
        _this.setPriorHtml(wrapper.html());
        return _this;
    }
    VueTester.prototype.fillIn = function (name, value) {
        var input = this.wrapper.find("[name=\"".concat(name, "\"]"));
    ...
    VueTester.prototype.nextHtml = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.wrapper.vm.$nextTick()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.wrapper.html()];
                }
            });
        });
    };
